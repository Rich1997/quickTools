...
const Sidebar = () => {
    ...
    return (
        <div className="fixed top-16 bottom-0 hidden tablet:flex flex-col gap-1 min-w-[160px] w-48 border-r border-base-content/20 bg-base-100 overflow-auto py-12 pl-3 pr-6 select-none">
