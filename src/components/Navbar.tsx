                    ...
                    <div className="tablet:hidden block cursor-pointer p-2 d-s">
                        <Dialog.Root>
                            ...
                            <Dialog.Portal>
                                ...
                                <Dialog.Content className="block tablet:hidden overflow-auto data-[state=open]:animate-contentShow fixed top-44 left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] focus:outline-none d-s">
