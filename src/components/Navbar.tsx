        ...
        <div className="border-b border-base-content/20">
            <div className="flex items-center justify-between gap-4 flex-wrap text-base-content py-4 px-6 max-w-6xl mx-auto">
                ...
                <Dialog.Root>
                    ...
                    <Dialog.Portal>
                        <Dialog.Content className="block tablet:hidden overflow-auto data-[state=open]:animate-contentShow fixed min-[0px]:top-[240px] max-[346px]:top-[240px] min-[347px]:top-[222px] left-[50%] max-h-[85vh] w-[90vw] translate-x-[-50%] translate-y-[-50%] focus:outline-none bg-base-100 rounded d-b">
